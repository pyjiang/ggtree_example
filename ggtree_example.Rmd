...
### for more information ,check ggtree online [documentation](https://guangchuangyu.github.io/ggtree-book/chapter-ggtree.html)
...
### read in the annotation file with a subset of 618 strains 
...
all_strains <- CA_ratio_pval_tb[,"strains"]
...
### Annotate the tree: assign strains into 2 groups 
...
### add a circle to a subset of strains 
```{r}
...
###If want to show a bunch of strains, which do not belong to a monophyletic group
...
p2 <- p2 + geom_cladelabel(n1, "Wine/European", fontsize=3, offset=0, hjust=1.2) +
  ...
  geom_cladelabel(n17, "Mosaic beer",angle=10, fontsize=3, offset=0.5, hjust=1, barsize=0.5) + 
  geom_cladelabel(n18, "Mixed origin",angle=30, fontsize=3, offset=0.5, hjust=1, barsize=0.5) + 
  ...
  geom_cladelabel(n15, "Asian fermentation",angle=40, fontsize=3, offset=0.2, hjust=1) + 
